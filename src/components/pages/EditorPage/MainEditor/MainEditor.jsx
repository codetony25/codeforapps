...
import {
  ...
  EverLibToolbar,
  EverLibEditorStats
} from '../../../../core/modules/everlib_editor';
...
class MainEditor extends React.Component {
  ...
  constructor(props) {
    ...
    console.log(props.book.draft.chapters[props.selectedChapter].text);

    this.displayName = 'MainEditor';
    this.initialText =
  ...
  render() {
    console.log('Rendering in MainEditor');
