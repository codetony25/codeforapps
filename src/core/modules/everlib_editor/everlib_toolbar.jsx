...
import BlockTypeButton from './buttons/block_type_button.jsx';
import InlineStyleButton from './buttons/inline_style_button.jsx';
import { toggleFullScreen } from '../../utils/DOMUtils';
      ...
      <div className="everlib-editor-toolbar">
        ...
        <div className="toolbar-container-right">
          <div className="chapter-navigate toolbar-btn-group">
            ...
            <span className={this.props.methods.atLastChapter() ?
                "toolbar-btn disabled" : "toolbar-btn"}
