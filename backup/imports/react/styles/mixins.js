...
import { globalColor } from './scheme'
import { font, themeColor } from '/imports/react/styles/variables';

// Font Mixin - This will also generate fallback font for us too
const fallbackFonts = 'Open Sans, sans-serif';

export const fontMixin = (options) => {
...
export const fontResponsive = (options) => {
...
// Flex Padding Center
export const flexDeadCenterPadding = () => {
  return {
    display: 'flex',
    justifyContent: 'center',
    paddingTop: 70,
 ...
 */
export const button = (btnTextColor, btnBgColor) => {
  return {
    mixin: fontMixin({
...
export const everLibLogoMixin = (options) => {
