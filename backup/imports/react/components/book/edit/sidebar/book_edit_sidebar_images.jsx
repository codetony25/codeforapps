...
class BookEditSidebarImages extends React.Component {
  ...
  constructor(props) {
    ...
    this.displayName = 'BookEditSidebarImages';
  ...
  handleImageChange = (event) => {
    ...
    // TODO: Validation
    if (!file || !file.name || !file.name.toLowerCase().includes('.png', file.name.length-4)) {
      this.setState({
  ...
  render() {
    console.log('Rendering BookEditSidebarImages');
    return (
      <div className="user-sidebar-images">
...
export default BookEditSidebarImages;