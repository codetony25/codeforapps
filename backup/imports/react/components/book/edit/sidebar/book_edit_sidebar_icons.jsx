...
class BookEditSidebarIcons extends React.Component {
  
  constructor(props) {
    super(props);

    this.displayName = 'BookEditSidebarIcons';
  }

  render() {
    console.log('Rendering BookEditSidebarIcons');
    return (
...
export default BookEditSidebarIcons;
