...
class BookEditChapters extends React.Component {
  ...
  constructor(props) {
    ...
    this.displayName = 'BookEditChapters';
  }
  ...
  render() {
    console.log('Rendering BookEditSidebarChapters');
    return (
      <div className="book-edit-sidebar-chapters">
        {this.renderSearch()}
        <this.SortableList
